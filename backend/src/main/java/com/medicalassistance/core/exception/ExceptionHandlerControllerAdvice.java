...
import com.medicalassistance.core.response.ErrorResponse;
import com.medicalassistance.core.response.ExceptionResponse;
...
public class ExceptionHandlerControllerAdvice {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public @ResponseBody
    ExceptionResponse handleInvalidInputException(final InvalidUserRequestException exception,
                                                  final HttpServletRequest request) {
